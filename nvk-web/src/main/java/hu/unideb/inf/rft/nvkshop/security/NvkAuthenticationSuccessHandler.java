...
public class NvkAuthenticationSuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler {

	/** Cookie name of the last user */
	public static final String COOKIE_LAST_USERNAME = "LAST_USERNAME";

	/** SLF4J Logger */
	private final Logger log = LoggerFactory.getLogger(NvkAuthenticationSuccessHandler.class);

	/**
	 * NVK authentication success handler.
	 */
	public NvkAuthenticationSuccessHandler() {
	}
